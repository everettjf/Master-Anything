 ...
 *
 * This module only builds and exports the Hono `app`; a transport wraps it:
 *  - index.ts  serves it at the root path (dev: vite proxies /api here)
 *  - serve.ts  mounts it under /api alongside the built web UI (npx, one port)
 */
